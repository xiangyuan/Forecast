...
(
   ...
   QualitativeRank      char(1) comment '优，良，中，差，很差',
...
(
   ...
   QuanlitativeRank     char(1) comment '优，良，中，差，很差',
...
create table Users
(
   UserID               char(1) not null comment '主键，用户注册时填写，并进行唯一性检查',
   UserPassword         char(1) comment '注册时填写',
