package org.iblogger.utils.upload;
...
import org.iblogger.exception.SmartUploadException;
...
public class SmartUpload {
	...
	public void upload(String charsetName) throws ServletException,
		...
		for (m_currentIndex++; m_currentIndex < m_totalBytes; m_currentIndex = m_currentIndex + 2) {
			...
			if (flag3) {
				...
				String s11 = new String(m_binArray, m_startData,
						(m_endData - m_startData) + 1, charsetName);
